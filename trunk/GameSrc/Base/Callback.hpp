/*
 *	This code has been written by Elbert Mai.
 *	Found at CodeProject.
 *	URL to original article: http://www.codeproject.com/Articles/136799/Lightweight-Generic-C-Callbacks-or-Yet-Another-Del#note2
 *
 */
...
#define UTIL_GET_CALLBACK_FACTORY_BIND_FREE(freeFuncPtr) \
    (GetCallbackFactory(freeFuncPtr).Bind<freeFuncPtr>())
